...
def introduction_with_language(name, language)
  puts "Hi! My name is #{name} I'm learning to program in #{language}"
end
...
puts introduction(Ty)

puts introduction_with_language(Ty, Ruby)

puts introduction_with_language_optional(Ty)
